                    ...
                    <!-- <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-3">
                        <div class="card border-0">
                            <ul class="list-unstyled py-2 px-3">
                                <li>
                                    <a href="#" class=""><img src="{{asset('assets/admin/images/flag/GB.png')}}" alt=""> English</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('assets/admin/images/flag/DE.png')}}" alt=""> German</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('assets/admin/images/flag/FR.png')}}" alt=""> French</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('assets/admin/images/flag/IT.png')}}" alt=""> Italian</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('assets/admin/images/flag/RU.png')}}" alt=""> Russian</a>
                                </li>
                            </ul>
                        </div>
                    </div> -->
                                    ...
                                    <ul class="list-unstyled list mb-0">
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="{{asset('assets/admin/images/xs/avatar1.svg')}}" alt="">
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="{{asset('assets/admin/images/xs/avatar3.svg')}}" alt="">
                                                <div class="flex-fill ms-2">
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="{{asset('assets/admin/images/xs/avatar5.svg')}}" alt="">
                                                <div class="flex-fill ms-2">
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="{{asset('assets/admin/images/xs/avatar6.svg')}}" alt="">
                                                <div class="flex-fill ms-2">
                                        ...
                                        <li class="py-2">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="{{asset('assets/admin/images/xs/avatar7.svg')}}" alt="">
                                                <div class="flex-fill ms-2">
