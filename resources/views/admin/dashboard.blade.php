                        ...
                        <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="{{asset('assets/admin/images/product/product-1.jpg')}}" class="avatar lg rounded me-2" alt="profile-image"><span> Oculus VR </span></td>
                                    <td>Molly</td>
                                    <td>Credit Card</td>
                                    <td>
                                        $420
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('assets/admin/images/product/product-2.jpg')}}" class="avatar lg rounded me-2" alt="profile-image"><span>Wall Clock</span></td>
                                    <td>Brian</td>
                                    <td>Debit Card</td>
                                    <td>
                                        $220
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('assets/admin/images/product/product-3.jpg')}}" class="avatar lg rounded me-2" alt="profile-image"><span>Note Diaries</span></td>
                                    <td>Julia</td>
                                    <td>Debit Card</td>
                                    <td>
                                        $250
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('assets/admin/images/product/product-4.jpg')}}" class="avatar lg rounded me-2" alt="profile-image"><span>Flower Port</span></td>
                                    <td>Sonia</td>
                                    <td>Credit Card</td>
                                    <td>
                                        $320
